...
class StarTopo(Topo):
    ...
    def __init__(self, n=4, cpu=None, bw_host=1000, bw_net=1.5,
        ...
        self.addLink('h1', 's0', bw= bw_host,max_queue_size=int(maxq) )
        self.addLink('h2', 's1', bw= bw_host,max_queue_size=int(maxq) )
        self.addLink('h3', 's0', bw= bw_host,max_queue_size=int(maxq) )
        self.addLink('h4', 's1', bw= bw_host,max_queue_size=int(maxq) )

        self.addLink('s1', 's0', bw= bw_host,max_queue_size=int(maxq) )
